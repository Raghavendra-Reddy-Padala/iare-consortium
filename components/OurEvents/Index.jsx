...
const OurEvents = () => {
  ...
  return (
    <section id="events" className="relative section-container">
      <div className="mb-12 lg:mb-0">
        <SectionTitle title={"Our Events"} />
        <p className="mt-4 ml-[84px] 2xl:ml-[145px] text-gray-600 text-sm md:text-base lg:text-lg">
          Tap on the cards to know more
        </p>
      </div>
