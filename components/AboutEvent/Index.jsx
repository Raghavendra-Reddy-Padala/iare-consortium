...
const AboutEvent = () => {
  ...
  <p className="text-xl 2xl:text-3xl lg:text-2xl">
    <b>Consortium 2025</b> is the national-level technical fest of the Institute of Aeronautical Engineering (IARE), Hyderabad. presenting a platform for technical expos, hackathons, competitions, workshops, and paper presentations.<br /><br />
    
    The organizing team leads the fest arrangements, ensuring an enriching technical experience for all attendees.
  </p>
  <div className="gap-4 columns-2 2xl:text-4xl lg:text-3xl text-xl font-bold mt-[15px] pr-2">
    <div className="flex-row">
      <p className="2xl:text-7xl lg:text-6xl text-2xl">20+</p>
      <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base">Events and</p>
      <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base">Competitions</p>
    </div>
    <div className="flex items-start gap-2 ">
      <p className="2xl:text-7xl lg:text-6xl text-2xl">5000+</p>
      <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base mt-[25px]">Participants Nationwide</p>
    </div>
  </div>
</div>
